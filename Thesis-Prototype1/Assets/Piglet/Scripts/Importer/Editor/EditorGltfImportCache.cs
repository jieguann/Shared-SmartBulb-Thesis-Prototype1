    ...
    public class EditorGltfImportCache : GltfImportCache
    {
            ...
            int index, List<KeyValuePair<Mesh, Material>> mesh)
        {
            ...
            for (int i = 0; i < mesh.Count; ++i)
            {
                ...
                // Mesh will be null if the mesh failed to import for any
                // reason (e.g. attempting to import a Draco-compressed
                // mesh when the DracoUnity package is not installed).
